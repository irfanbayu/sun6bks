      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-400">
            Jangan sampai kehabisan tiket! Pilih event favoritmu dan siap-siap ketawa lepas.
          </p>
        </motion.div>
        ...
        >
          {SAMPLE_EVENTS.map((event) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm transition-all duration-300 hover:border-sun6bks-gold/30"
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-4 space-y-2 text-sm text-gray-400">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="truncate">{event.performers.join(", ")}</span>
                  </div>
                </div>
